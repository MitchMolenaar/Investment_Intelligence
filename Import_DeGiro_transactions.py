...
To do:
    ...
    - wisselkoersen toevoegen bij kopen aandeel buitenlandse markt.
...
if check_portfolio_of=='Timo':
    ...
    [portfolio,comp]=simple_dashboard(r'C:\Users\ttmoo\Documents\Administratie\Privé\Github\Transactions.csv',
                           r'C:\Users\ttmoo\Documents\Administratie\Privé\Github\Account.csv', companies)


if check_portfolio_of=='Mitch':
    companies = [['IBM', 'INTERNATIONAL BUSINESS', 'Technology'],
                 ['GLPG.AS', 'GALAPAGOS', 'Health Care'], 
                 ['IEUR', 'ISHARES MSCI EUR A', 'ETF'], 
                 ['RDSA.AS', 'ROYAL DUTCH SHELLA', 'Energy'],
                 ['PHARM.AS', 'PHARMING GROUP', 'Health care'],
                 ['GOOG', 'ALPHABET INC. - CLASS A', 'Technology'],
                 ['ASML.AS', 'ASML HOLDING', 'Technology'],
                 ['DSM.AS', 'DSM KON', 'Technology']]
    
    [portfolio,comp]=simple_dashboard(r'C:\Users\mitch\Documents\GitHub\Investment_Intelligence\Transactions.csv',
